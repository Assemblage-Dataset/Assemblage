...
class TestDBManager(unittest.TestCase):
    ...
    def test_get_projects_row_by_id(self):
        ...
        expected_data = {
            ...
            "created_at": datetime.datetime(2025, 11, 15, 12, 28, 25),
            "deleted": False,
            "forked_commit_id": 0,
            "priority": const.PriorityStatus.LOW,
        ...
        self.assertEqual(out.id, INPUT_ID, "Row with matching ID was not retrieved")
        self.assertEqual(
            out.__dict__,
            expected_data,
    ...
    def test_get_dispatch_msg(self, MockConn, MockChan):
        ...
        message_expected = msg.BuilderTaskOut(
            ...
            task_id=1,
            opt_id=1,
            output_dir=f"{const.BIN_DIR}/1",
            repo_id=1,
            updated_at="11/15/2025, 12:41:59",
            build_system="BUILD_SYS",
            msg_time=ANY,
            commit_hexsha="",
            mod_timestamp="",
    ...
    def test_update_repo_status_various_configs(self):
        ...
        # clone info callback
        dbm.update_repo_status(
            status_id=3, clone_status=const.CloneStatus.FAILED, clone_msg="test2"
        )
