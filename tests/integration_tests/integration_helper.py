...
def seed_database_projects():
    ...
    dict1 = msg.ScraperDataOutSingle (            
        'PROJECT_1', 'URL_1', 'LANG', 11, 'DESCRIPTION',
        '2025-11-15 12:28:25', '2025-11-15 12:41:59', 5, 'BUILD_SYS', 'BRANCH'
    ).to_dict()
    dict2 = msg.ScraperDataOutSingle (            
        'PROJECT_2', 'URL_2', 'LANG', 12, 'DESCRIPTION',
        '2025-11-15 12:28:25', '2025-11-15 12:41:59', 10, 'BUILD_SYS', 'BRANCH'
    ).to_dict()
    dict3 = msg.ScraperDataOutSingle (            
        'PROJECT_3', 'URL_3', 'LANG', 13, 'DESCRIPTION',
        '2025-11-15 12:28:25', '2025-11-15 12:41:59', 15, 'BUILD_SYS', 'BRANCH'
    ).to_dict()
...
def seed_database_buildopts():
    buildopt1 = {
        'platform':'linux', 'language':'c++', 'compiler_name':'clang', 
        'build_system':'all', 'library':'x64', 'enable':True, 
        'compiler_version':'10.0.0', 'save_assembly':True
    }
    buildopt2 = {
        'platform':'linux', 'language':'c++', 'compiler_name':'gcc', 
        'build_system':'all', 'library':'x64', 'enable':True, 
        'compiler_version':'10.0.0', 'save_assembly':True
    }
    with helper_dbm.get_session() as session:
...
def seed_database_statuses_unstarted():
    ...
    project1_b2 = { 'clone_status': const.CloneStatus.NOT_STARTED, 'build_status': const.BuildStatus.INIT, 'build_opt_id': 2, 'repo_id': 1 }
    project2_b1 = { 'clone_status': const.CloneStatus.NOT_STARTED, 'build_status': const.BuildStatus.INIT, 'build_opt_id': 1, 'repo_id': 2 }
    project2_b2 = { 'clone_status': const.CloneStatus.NOT_STARTED, 'build_status': const.BuildStatus.INIT, 'build_opt_id': 2, 'repo_id': 2 }
    project3_b1 = { 'clone_status': const.CloneStatus.NOT_STARTED, 'build_status': const.BuildStatus.INIT, 'build_opt_id': 1, 'repo_id': 3 }
    project3_b2 = { 'clone_status': const.CloneStatus.NOT_STARTED, 'build_status': const.BuildStatus.INIT, 'build_opt_id': 2, 'repo_id': 3 }
    with helper_dbm.get_session() as session:
