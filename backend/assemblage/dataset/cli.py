...
from assemblage.dataset.construct import db_construct, process, update_license
...
@click.option(
    "--dest", help="The destination folder for the data, will be created and overwritten."
)
@click.option(
    "-g", is_flag=True, help="Generate dataset, you need also need to provide other specs"
)
