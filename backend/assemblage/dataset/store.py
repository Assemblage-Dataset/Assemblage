...
from assemblage.dataset.orm import PDB, RVA, Binary, Function, Line, init_clean_database
...
class Dataset_DB:
    ...
    def __init__(self, db_addr):
        ...
        self.engine = create_engine(db_addr, echo=False, pool_pre_ping=True)
    ...
    def add_function(self, name, source_file, rvas, binary_id):
        with Session(self.engine) as session:
            new_function = Function(
                name=name, source_file=source_file, rvas=rvas, binary_id=binary_id
            )
